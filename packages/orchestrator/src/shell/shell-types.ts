...
export const SHELL_BUILTINS = new Set(['echo', 'which', 'chmod', 'test', '[', 'pwd', 'cd', 'export', 'unset', 'date', 'curl', 'wget', 'exit', 'true', 'false', 'pkg', 'pip', 'history', 'source', '.', 'set', 'read', 'eval', 'getopts', 'return', 'local', 'trap', 'declare', 'typeset', 'shift', 'type', 'command', 'let', 'printf', 'mapfile', 'readarray', 'exec', 'readonly', 'pushd', 'popd', 'dirs']);
